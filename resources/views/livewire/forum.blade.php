        ...
        <div class="flex flex-col w-full gap-3 pb-5">
            ...
            <div class="flex w-full gap-2.5 ">
                ...
                <div class="flex justify-end">
                    <a href="" class="text-sm font-normal text-gray-900 underline dark:text-white">Comments</a>
                </div>
                </div>
                ...
                <div id="dropdownDots" class="z-10 hidden w-40 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
